################################################################################
#  hke.27.3a46-8abd_assessment : short-term forecast GM summary                #
#------------------------------------------------------------------------------#
...
# model_02c_ForecastGM_summary.R - STF output summaries (with geometric mean recruitment)
# ~/*_hke.27.3a46-8abd_assessment/model_02c_ForecastGM_summary.R
...
load(file.path(dir.fored, "forecast.RData"))
...
write.csv(Table_InterR, file.path(dir.tableadv, "table_intermediate_yearGM_icesRound.csv"), row.names = FALSE)
write.csv(Table_fmult, file.path(dir.tablefore, "table_Fmult.csv"), row.names = FALSE)
# write.csv(Table_fmultR, file.path(tabledir_xxx, "table_Fmult_GM_icesRound.csv"), row.names = FALSE)
